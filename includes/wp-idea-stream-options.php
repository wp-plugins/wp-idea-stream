	...
	<h2><?php _e('IdeaStream Options','wp-idea-stream');?></h2>
		<form action="" method="post">
			<div id="ideastream_submission_config" class="idea-options">
				<fieldset>
					<legend><?php _e('Idea Submission Options','wp-idea-stream');?></legend>
					<table>
						<tr><th><label for="_idea_editor_image"><?php _e('Image Button','wp-idea-stream');?></label></th>
							...
							<th><label for=""><?php _e('Status of new ideas','wp-idea-stream');?></label></th>
						...
						<tr><th><label for="_idea_editor_link"><?php _e('Link Button','wp-idea-stream');?></label></th>
						...
						<tr><th><label for="_idea_editor_image_size"><?php _e('Image max width in pixels <small>(default is 300)</small>','wp-idea-stream');?></label></th>
							...
							<th><label for="_ideastream_login_message"><?php _e('Message to display if user is not logged in','wp-idea-stream');?></label></th>
			...
			<div id="ideastream_other_config" class="idea-options">
				<fieldset>
					<legend><?php _e('IdeaStream Ratings, Sharing and Featuring Options', 'wp-idea-stream');?></legend>
					<table>
						<tr>
							<th style="width:200px"><label><?php _e('Built in rating system', 'wp-idea-stream');?></th>
							<td style="width:200px"><input type="radio" value="yes" name="_ideastream_builtin_rating" <?php if(!$ideastream_builtin_rating || is_option_checked($ideastream_builtin_rating, "yes")) echo "checked";?>>
								<?php _e('Activate');?>&nbsp;
								<input type="radio" value="no" name="_ideastream_builtin_rating" <?php if(is_option_checked($ideastream_builtin_rating, "no")) echo "checked";?>>
								<?php _e('Deactivate');?>
							</td>
							<th colspan="2"><label><?php _e('Comma separated list of captions for the stars','wp-idea-stream');?></th>
						</tr>
						<tr><td colspan="2">&nbsp;</td><td colspan="2"><input type="text" value="<?php echo $implode_stars_caption;?>" name="_ideastream_hint_list" style="width:100%"></td></tr>
						<tr><td colspan="4" class="idea-sep">&nbsp;</td></tr>
						<tr>
							<th><label><?php _e('Sharing options', 'wp-idea-stream');?></label></th>
							<td><input type="radio" value="yes" name="_ideastream_sharing_options" <?php if(!$ideastream_sharing_options || is_option_checked($ideastream_sharing_options, "yes")) echo "checked";?>>
								<?php _e('Activate');?>&nbsp;
								<input type="radio" value="no" name="_ideastream_sharing_options" <?php if(is_option_checked($ideastream_sharing_options, "no")) echo "checked";?>>
								<?php _e('Deactivate');?>
							</td>
							<th><label><?php _e('Twitter account <small>(leave blank to disable)</small>','wp-idea-stream')?></label></th>
							<td><input type="text" value="<?php echo get_option('_ideastream_twitter_account');?>" name="_ideastream_twitter_account">
							</td>
						</tr>
						<tr><td colspan="4" class="idea-sep">&nbsp;</td></tr>
						<tr>
							<th><label><?php _e('Featuring ideas in comment area','wp-idea-stream');?></label></th>
							<td><input type="radio" value="yes" name="_ideastream_feature_from_comments" <?php if(is_option_checked($ideastream_feature_from_comments, "yes")) echo "checked";?>>
									<?php _e('Activate');?>&nbsp;
									<input type="radio" value="no" name="_ideastream_feature_from_comments" <?php if(!$ideastream_feature_from_comments || is_option_checked($ideastream_feature_from_comments, "no")) echo "checked";?>>
									<?php _e('Deactivate');?>
							</td>
						...
						<tr>
							<th colspan="2"><label><?php _e('Add a comma separated list of trusted user ids to help you','wp-idea-stream');?></label></th>
							<td colspan="2"><input type="text" value="<?php echo $implode_user_ids;?>" name="user_ids_help" style="width:100%">
							</td>
						</tr>
					</table>
				</fieldset>
