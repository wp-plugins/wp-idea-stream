(function() {
        ...
        tinymce.create('tinymce.plugins.WPideaStreamImg', {
                /**
                ...
                init : function(ed, url) {
                        ...
                        ed.addCommand('mceWPideaStreamImg', function() {
                        ...
                        ed.addButton('WPideaStreamImg', {
                                title : 'Add a photo',
                                cmd : 'mceWPideaStreamImg',
                                image : url + '/img/wpis-image.gif',
								/*onclick : function() {
                        ...
                        ed.onNodeChange.add(function(ed, cm, n) {
                                cm.setActive('WPideaStreamImg', n.nodeName == 'IMG');
                        });
                },
                ...
                getInfo : function() {
                        return {
                                longname : 'WP Idea Stream Photo menu',
                                author : 'imath',
        ...
        // Register plugin
        tinymce.PluginManager.add('WPideaStreamImg', tinymce.plugins.WPideaStreamImg);
})();