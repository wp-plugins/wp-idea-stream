<?php
/**
 * The template for displaying ideas by tag.
 *
	...
	<div id="primary" class="site-content">
		<div id="content" role="main">
			...
			<header class="archive-header">
				<h1 class="archive-title"><?php printf( __( 'Tag Archives: %s | %s ideas were posted in this tag so far', 'wp-idea-stream' ), '<span>' . single_tag_title( '', false ) . '</span>', '<span>' . wp_idea_stream_number_ideas() . '</span>' );?></h1>
