<?php 
/**
 * The template for displaying Idea categories.
 *
 * @package WordPress
...
<div id="container">
	<div id="content" role="main">
		...
		<?php do_action('wp_idea_stream_before_cat_loop');?>
				...
				<div id="post-0" class="post error404 not-found">
					...
					<div class="entry-content">
						...
						if(is_user_logged_in()){
							printf( __('OOps, It looks like no idea has been submitted in this category yet, <a href="%s" title="Submit your idea">add yours</a>', 'wp-idea-stream'), wp_idea_stream_new_form() );
						}else{
							_e( 'OOps, It looks like no idea has been submitted in this category yet, please log in to add yours!', 'wp-idea-stream' );
						}
						?>
					</div><!-- .entry-content -->
				</div><!-- #post-0 -->
		...
		<?php do_action('wp_idea_stream_after_cat_loop');?>
